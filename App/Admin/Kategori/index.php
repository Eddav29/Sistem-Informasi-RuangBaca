                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href='index.php?page=edit&id=<?= $row_kategori["ID_KATEGORI"] ?>' class="btn btn-warning btn-xs m-1"><i class="fa fa-pencil-square-o"></i>Edit</a>
                                                <a href='index.php?page=kategori&id=<?= $row_kategori["ID_KATEGORI"] ?>' onclick="javascript:return confirm('Hapus Data Kategori?');" class="btn btn-danger btn-xs m-1"><i class="fa fa-pencil-square-o"></i>Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                            <?php
