        ...
        LEFT JOIN 
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="table-container">
                    ...
                    <table id="tablePeminjaman">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <button type="button" class="btn btn-warning btn-xs" onclick="location.href='Peminjaman.php?id=<?= $row['ID Peminjaman'] ?>'">
                                        <i class="fa fa-pencil-square-o"></i> Edit
                                    </button>


                                    <button type="button" class="btn btn-danger btn-xs" onclick="deleteConfirmation(<?= $row['ID Peminjaman'] ?>)"><i class="fa fa-trash"></i>Hapus</button>
                            <?php
                                    echo "</td>";
                                    echo "</tr>";
                                }
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="ID_MEMBER" class="form-control" method="post" id="recipient-name">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3 d-flex justify-content-end">
                                            ...
                                            <button type="submit" name="submit" class="btn btn-primary ms-2" aria-hidden="true">
                    ...
                    <div class="modal fade" id="editModal<?= $row['ID_MEMBER'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="Functions/Kategori.php" method="POST">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="editNama" name="NAMA_MEMBER" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="judul_buku" class="col-form-label">Judul Buku:</label>
                                            <input type="text" name="JUDUL_BUKU" class="form-control" id="judul_buku">
                ...
                <div class="modal fade" id="deleteModal<?= $row['ID_MEMBER'] ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?= $row['ID_MEMBER'] ?>" aria-hidden="true">
        ...
        <div class="table-container">
            ...
            <table id="tablePengembalian">
                ...
                <tbody>
                    ...
                    ?>
                            <!-- Tombol Edit dan Hapus dalam bentuk button -->
                            <button type="button" class="btn btn-warning btn-xs" onclick="location.href='Pengembalian.php?id=<?= $row['ID Pengembalian'] ?>'"><i class="fa fa-pencil-square-o"></i>Edit</button>
                            <button type="button" class="btn btn-danger btn-xs" onclick="deleteConfirmation(<?= $row['ID Pengembalian'] ?>)"><i class="fa fa-trash"></i>Hapus</button>
                    <?php
                            echo "</td>";
                            echo "</tr>";
                        }
