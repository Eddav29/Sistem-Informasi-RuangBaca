                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex ">
                                            <a href='index.php?page=edit&id=<?= $row_kategori["ID_BUKU"] ?>'
                                                data-bs-toggle="modal" data-bs-target="#myModal<?= $row['ID_BUKU']; ?>"
                                        ...
                                        <div id="myModal<?= $row['ID_BUKU'] ?>" class="modal fade" data-bs-backdrop="static"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="" method="post">
                                <div class="modal-body custom-modal-body">
                                    ...
                                    <div class="mb-3 row form-group">
                                        <label for="ketersediaan" class="col-sm-3 col-form-label">Tanggal
                                            Pengadaan</label>
                                        <div class="col-sm-9">
