<div class="container-fluid">
    <div class="row">
        ...
        $delete = $petugas->hapusPetugasFromForm();
            ...
            <div class="row">
                                ...
                                <tr id="<?= $row['ID_MEMBER'] ?>">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="index.php?page=petugas&idMember=<?= $row['ID_MEMBER'] ?>" onclick="javascript:return confirm('Hapus Data Petugas?');" class="btn btn-danger btn-xs m-1"><i class="fa fa-trash"></i></a>    
                                        </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel"><i class="fa fa-users"></i> Edit Data Prtugas</h5>
                ...
                <div id="exampleModal" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true" tabindex="-1">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel"><i class="fa fa-users"></i> Tambah Petugas</h5>
                                                        <button type="button" class="btn-close-style " data-bs-dismiss="modal" aria-label="Close">
                                                            <i class="fa-solid fa-xmark"></i>
                                                        </button>
                                                    </div>
                                                    <form action="" method="post">
                                                        <div class="modal-body custom-modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <br>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" class="form-check-input" name="iden" id="iden" value="KTM">
                                                                    <label class="form-check-label" for="inlineRadio1">KTM</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" class="form-check-input" name="iden" id="iden" value="KTP">
                                                                    <label class="form-check-label" for="inlineRadio2">KTP</label>
                                                                </div>
                                                            </div>
                                                            <div class="mb-3 row form-group">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <br>
                                                                <div class="form-check form-check-inline">
                                                                    <input type="radio" class="form-check-input" name="level" id="level" value="Admin" checked>
                                                                    <label class="form-check-label" for="inlineRadio2">Admin</label>
                                                                </div>
                                                            </div>
