    ...
    <!-- <div class="container-fluid mt-1">
        <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-end">
                <button class="btn btn-outline-light border-dark login-darkblue" type="submit">
...
<script>
    // this script to handle the click event on the "Log in" button
    document
    ...
    // this script to handle the click event on the "Register" link
    document
