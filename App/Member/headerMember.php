...
<head>
  ...
  <meta name="author" content="Eddo,fathur,yayun,yunila,syahrul,ade">
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
      <ul class="nav sidebar-nav">
        ...
        <li class="nav-item"><a href="index.php?page=History"><i class="fa-solid fa-book"></i> History</a></li>
        <li class="nav-item"><a href="index.php?page=Notifikasi"><i class="fa-solid fa-list"></i> Notifikasi</a></li>
